...
__defold_support_Init.init = function(exports) 
  local script = Board.new();
  exports.Board_init = function(_self) 
    script:init(_self);
  end;
  exports.Board_on_message = function(self1,message_id,message,_) 
    script:on_message(self1, message_id, message, _);
  end;
  exports.Board_on_input = function(self2,action_id,action) 
    do return script:on_input(self2, action_id, action) end;
  end;
  exports.Board_on_reload = function(_1) 
  end;
  local script1 = __gui_NoDropRoom.new();
  exports.gui_NoDropRoom_init = function(self3) 
    script1:init(self3);
  end;
  exports.gui_NoDropRoom_update = function(self4,dt) 
    script1:update(self4, dt);
  end;
  exports.gui_NoDropRoom_on_message = function(self5,message_id1,message1,_2) 
    script1:on_message(self5, message_id1, message1, _2);
  end;
  local script2 = __gui_MainMenu.new();
  exports.gui_MainMenu_init = function(_3) 
    script2:init(_3);
  end;
  exports.gui_MainMenu_on_input = function(_4,action_id1,action1) 
    do return script2:on_input(_4, action_id1, action1) end;
  end;
  local script3 = __gui_Restart.new();
  exports.gui_Restart_on_message = function(_5,message_id2,message2,_6) 
    script3:on_message(_6, message_id2, message2, _6);
  end;
  exports.gui_Restart_on_input = function(_7,action_id2,action2) 
    do return script3:on_input(_7, action_id2, action2) end;
  end;
  local script4 = __gui_PresentLevel.new();
  exports.gui_PresentLevel_init = function(_8) 
    script4:init(_8);
  end;
  exports.gui_PresentLevel_on_message = function(_9,message_id3,message3,_10) 
    script4:on_message(_10, message_id3, message3, _10);
  end;
  local script5 = Block.new();
  exports.Block_init = function(self6) 
    script5:init(self6);
  end;
  exports.Block_final_ = function(self7) 
    script5:final_(self7);
  end;
  exports.Block_on_message = function(self8,message_id4,message4,_11) 
    script5:on_message(self8, message_id4, message4, _11);
  end;
  local script6 = Main.new();
  exports.Main_init = function(self9) 
    script6:init(self9);
  end;
  exports.Main_on_message = function(self10,message_id5,message5,sender) 
    script6:on_message(self10, message_id5, message5, sender);
  end;
  local script7 = __gui_Board.new();
  exports.gui_Board_init = function(_12) 
    script7:init(_12);
  end;
  exports.gui_Board_on_message = function(_13,message_id6,message6,_14) 
    script7:on_message(_14, message_id6, message6, _14);
  end;
  exports.gui_Board_on_input = function(_15,action_id3,action3) 
    do return script7:on_input(_15, action_id3, action3) end;
  end;
  local script8 = Connector.new();
  exports.Connector_init = function(_16) 
    script8:init(_16);
  end;
  local script9 = __gui_LevelComplete.new();
  exports.gui_LevelComplete_init = function(_17) 
    script9:init(_17);
  end;
  exports.gui_LevelComplete_on_message = function(_18,message_id7,_19,_20) 
    script9:on_message(_20, message_id7, _20, _20);
  end;
  exports.gui_LevelComplete_on_input = function(_21,action_id4,action4) 
    do return script9:on_input(_21, action_id4, action4) end;
  end;
  local script10 = MagicFx.new();
  exports.MagicFx_init = function(self11) 
    script10:init(self11);
  end;
  exports.MagicFx_on_message = function(self12,message_id8,message7,_22) 
    script10:on_message(self12, message_id8, message7, _22);
  end;
end
