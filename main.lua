-- Generated by Haxe 3.4.0 (git build development @ d5a75a8)
...
Board.printBoard = function(_self,caption) 
  if (caption ~= nil) then 
    haxe.Log.trace(caption,_hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="Board.hx",lineNumber=308,className="Board",methodName="printBoard"}));
  end;
  local _g = 0;
  while (_g < 9) do 
    _g = _g + 1;
    ...
    while (_g1 < 7) do 
      _g1 = _g1 + 1;
      local cell = _self.board[_g1 - 1][(9 - y) - 1];
      r:push((function() 
        local _hx_1
        if (cell == nil) then 
    ...
    haxe.Log.trace(r:join(" "),_hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="Board.hx",lineNumber=316,className="Board",methodName="printBoard"}));
    end;
end
Board.slide_board = function(_self) 
  ...
  Board.printBoard(_self,"after slide");
  Board.build_blocklist(_self);
end
